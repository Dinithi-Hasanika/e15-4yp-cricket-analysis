# -*- coding: utf-8 -*-
"""Fielders_winD/I.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1JCmkNqaQyIB6RvyYSwDMo6YxjX8LV3Ie
"""
...
wb = gc.open_by_url('https://docs.google.com/spreadsheets/d/1peLpNFoEu8NHtVPttJXz4-aScixYu5dh_-6gYPOi9rQ/edit#gid=1446957294')
...
plt.show()
files.download("FieldersWinDI.png")
...
df1.to_csv('filders_winDIav_score.csv' , index=False)
files.download('filders_winDIav_score.csv')
